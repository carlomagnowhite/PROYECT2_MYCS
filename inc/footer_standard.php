    ...
    <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        <a class="text-white mb-2" href="curso1.php"><i class="fa fa-angle-right mr-2"></i>INTRODUCCIÓN A OPEN JOURNAL SYSTEM (OJS) DESDE LA EDICIÓN DE REVISTA</a>
                        <a class="text-white mb-2" href="curso2.php"><i class="fa fa-angle-right mr-2"></i>DEFENSA DIGITAL: SEGURIDAD TECNOLÓGICA Y PROTECCIÓN DE DATOS PERSONALES E INFORMÁTICOS.</a>
                        <a class="text-white mb-2" href="curso3.php"><i class="fa fa-angle-right mr-2"></i>ETHICAL HACKER</a>
                        <a class="text-white mb-2" href="curso4.php"><i class="fa fa-angle-right mr-2"></i>ENGLISH FOR 'IT' 1</a>
                        <a class="text-white mb-2" href="curso5.php"><i class="fa fa-angle-right mr-2"></i>FUNDAMENTOS DE CIENCIA Y ANALÍTICA DE DATOS</a>
        ...
        <div class="col-lg-5 col-md-12 mb-5">
            ...
            <div class="w-100">
                ...
                <div class="w-100">
                    <button class="btn btn-primary btn-lg" style="position: relative;"><a class="m-0 text-white" href="mailto:ctt.fisei@uta.edu.ec?Subject=Requiero%20información%20sobre%20sus%20cursos%20tecnológicos.">SOLICITAR
