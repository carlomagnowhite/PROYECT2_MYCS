    ...
    <div class="row pt-5">
        ...
        <div class="col-lg-5 col-md-12 mb-5">
            ...
            <div class="w-100">
                ...
                <div class="w-100">
                    <button class="btn btn-primary btn-lg" style="position: relative;"><a class="m-0 text-white" href="mailto:ctt.fisei@uta.edu.ec?Subject=Requiero%20información%20sobre%20sus%20cursos%20tecnológicos.">SOLICITAR INFORMACIÓN - CTT</a></button>
                </div>
            </div>
        </div>
    </div>
